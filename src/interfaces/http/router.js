...
module.exports = ({ config, auth_initialize, notFound, containerMiddleware, loggerMiddleware, errorHandler, openApiMiddleware }) => {
  const router = Router();
  ...
  apiRouter.use(auth.authenticate(), controller('controllers/UsersController.js'));
